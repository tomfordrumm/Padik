...
class SecretChatInvitationReceived extends Notification
{
    use Queueable;
    ...
    private function payload(): array
    {
        ...
        return [
            ...
            'room_title' => 'Secret chat',
            'sender_id' => $this->invitation->sender_id,
            'sender_name' => $this->invitation->sender->name,
            'body' => "{$this->invitation->sender->name} invited you to a secret chat.",
            'action_url' => route('secret-chats.show', ['conversation' => $this->invitation->conversation->slug]),
            'read_at' => null,
